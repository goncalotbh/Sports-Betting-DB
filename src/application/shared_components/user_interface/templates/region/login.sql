...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(117280764970888488999)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117280765250231488999)
,p_plug_template_id=>wwv_flow_imp.id(117280764970888488999)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117280765540472488999)
,p_plug_template_id=>wwv_flow_imp.id(117280764970888488999)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117280765817369488999)
,p_plug_template_id=>wwv_flow_imp.id(117280764970888488999)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117280766132739488999)
,p_plug_template_id=>wwv_flow_imp.id(117280764970888488999)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117280766405797488999)
,p_plug_template_id=>wwv_flow_imp.id(117280764970888488999)
,p_name=>'Sub Regions'
