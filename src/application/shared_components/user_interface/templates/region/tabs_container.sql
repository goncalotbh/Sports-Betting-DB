...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(117280779971414489005)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117280780216988489005)
,p_plug_template_id=>wwv_flow_imp.id(117280779971414489005)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117280780596782489005)
,p_plug_template_id=>wwv_flow_imp.id(117280779971414489005)
,p_name=>'Tabs'
