...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(117280762459441488997)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117280762750531488998)
,p_plug_template_id=>wwv_flow_imp.id(117280762459441488997)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117280763013642488998)
,p_plug_template_id=>wwv_flow_imp.id(117280762459441488997)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117280763348250488998)
,p_plug_template_id=>wwv_flow_imp.id(117280762459441488997)
,p_name=>'Button Start'
