...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(117280736744507488987)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117280737012825488987)
,p_plug_template_id=>wwv_flow_imp.id(117280736744507488987)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117280737302244488987)
,p_plug_template_id=>wwv_flow_imp.id(117280736744507488987)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117280737618491488987)
,p_plug_template_id=>wwv_flow_imp.id(117280736744507488987)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117280737933444488987)
,p_plug_template_id=>wwv_flow_imp.id(117280736744507488987)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117280738236944488987)
,p_plug_template_id=>wwv_flow_imp.id(117280736744507488987)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
