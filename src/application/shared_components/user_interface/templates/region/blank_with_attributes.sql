...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(117279902946776488973)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117279903276195488973)
,p_plug_template_id=>wwv_flow_imp.id(117279902946776488973)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117279903534241488973)
,p_plug_template_id=>wwv_flow_imp.id(117279902946776488973)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117279903875942488973)
,p_plug_template_id=>wwv_flow_imp.id(117279902946776488973)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117279904111524488973)
,p_plug_template_id=>wwv_flow_imp.id(117279902946776488973)
,p_name=>'Sub Regions'
