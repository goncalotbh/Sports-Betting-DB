...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(117279910051213488975)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117279910398472488975)
,p_plug_template_id=>wwv_flow_imp.id(117279910051213488975)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117279910603142488976)
,p_plug_template_id=>wwv_flow_imp.id(117279910051213488975)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117279910903659488976)
,p_plug_template_id=>wwv_flow_imp.id(117279910051213488975)
,p_name=>'Sub Regions'
