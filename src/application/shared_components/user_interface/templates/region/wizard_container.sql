...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(117280787606027489008)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117280787942139489008)
,p_plug_template_id=>wwv_flow_imp.id(117280787606027489008)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117280788238359489008)
,p_plug_template_id=>wwv_flow_imp.id(117280787606027489008)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117280788556430489008)
,p_plug_template_id=>wwv_flow_imp.id(117280787606027489008)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117280788849736489008)
,p_plug_template_id=>wwv_flow_imp.id(117280787606027489008)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117280789165031489008)
,p_plug_template_id=>wwv_flow_imp.id(117280787606027489008)
