...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(117280760327757488996)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117280760627948488997)
,p_plug_template_id=>wwv_flow_imp.id(117280760327757488996)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117280760972362488997)
,p_plug_template_id=>wwv_flow_imp.id(117280760327757488996)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117280761273504488997)
,p_plug_template_id=>wwv_flow_imp.id(117280760327757488996)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117280761557240488997)
,p_plug_template_id=>wwv_flow_imp.id(117280760327757488996)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117280761839323488997)
,p_plug_template_id=>wwv_flow_imp.id(117280760327757488996)
,p_name=>'Sub Regions'
