...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(117280767441290489000)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117280767701923489000)
,p_plug_template_id=>wwv_flow_imp.id(117280767441290489000)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117280768024880489000)
,p_plug_template_id=>wwv_flow_imp.id(117280767441290489000)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117280768372458489000)
,p_plug_template_id=>wwv_flow_imp.id(117280767441290489000)
,p_name=>'Sub Regions'
