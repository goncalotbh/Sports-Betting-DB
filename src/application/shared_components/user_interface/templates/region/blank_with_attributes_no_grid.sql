...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(117279904330333488973)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117279904684673488973)
,p_plug_template_id=>wwv_flow_imp.id(117279904330333488973)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117279904938876488973)
,p_plug_template_id=>wwv_flow_imp.id(117279904330333488973)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117279905271664488973)
,p_plug_template_id=>wwv_flow_imp.id(117279904330333488973)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117279905500499488974)
,p_plug_template_id=>wwv_flow_imp.id(117279904330333488973)
,p_name=>'Sub Regions'
