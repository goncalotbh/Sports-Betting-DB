...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(117280740251215488988)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117280740501825488988)
,p_plug_template_id=>wwv_flow_imp.id(117280740251215488988)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117280740860926488988)
,p_plug_template_id=>wwv_flow_imp.id(117280740251215488988)
,p_name=>'Sub Regions'
