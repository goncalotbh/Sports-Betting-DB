...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(117279887588363488965)
,p_theme_id=>42
,p_name=>'Modal Dialog'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117279887877436488965)
,p_page_template_id=>wwv_flow_imp.id(117279887588363488965)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117279888116203488966)
,p_page_template_id=>wwv_flow_imp.id(117279887588363488965)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117279888410520488966)
,p_page_template_id=>wwv_flow_imp.id(117279887588363488965)
