...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(117279877574058488961)
,p_theme_id=>42
,p_name=>'Login'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117279877843767488961)
,p_page_template_id=>wwv_flow_imp.id(117279877574058488961)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117279878195882488962)
,p_page_template_id=>wwv_flow_imp.id(117279877574058488961)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117279878473222488962)
,p_page_template_id=>wwv_flow_imp.id(117279877574058488961)
,p_name=>'Body Header'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117279878737672488962)
,p_page_template_id=>wwv_flow_imp.id(117279877574058488961)
,p_name=>'Body Footer'
