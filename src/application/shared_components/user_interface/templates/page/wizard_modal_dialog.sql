...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(117279896193776488969)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117279896523508488970)
,p_page_template_id=>wwv_flow_imp.id(117279896193776488969)
,p_name=>'Wizard Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117279896832976488970)
,p_page_template_id=>wwv_flow_imp.id(117279896193776488969)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(117279897139462488970)
,p_page_template_id=>wwv_flow_imp.id(117279896193776488969)
